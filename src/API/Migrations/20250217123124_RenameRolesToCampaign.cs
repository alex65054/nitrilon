...
{
    /// <inheritdoc />
    public partial class RenameRolesToCampaign : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampaignMember", x => new { x.CampaignsId, x.MembersId });
                    table.ForeignKey(
                        name: "FK_CampaignMember_Campaigns_CampaignsId",
                        column: x => x.CampaignsId,
                        principalTable: "Campaigns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CampaignMember_Members_MembersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignMember_MembersId",
